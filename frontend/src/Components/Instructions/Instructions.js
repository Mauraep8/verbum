        ...
        <div className="instructions">
            <p className="instructions__title">How to use:</p>
                <ul className="instructions__list">
                    ...
                    <li className="instructions__list-item">Click on edit icon <i className="bi bi-pencil-square"></i> to change verb list. Click <span className="instructions__list-item--bold">add/remove</span> to change current verbs and Save changes.</li>
                </ul>
        </div>
    )    
}