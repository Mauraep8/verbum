        ...
        <div className="instructions">
            <p className="instructions__title">How to use:</p>
                <ul className="instructions__list">
                    <li className="instructions__list-item"><span className="instructions__list-item--underlined">Write your answer</span> to the following instructions and click <span className="instructions__list-item--bold">Verify</span>.</li>
